...
**Source:** Cloned from [https://www.simular.ai/](https://www.simular.ai/) on 2026-05-15. This is a starter draft — compare `template.html` against `_source.png` and refine before publishing.
